...
class __mmc_help(mmc):
    ...
    def run(command):
        ...
        HELP_PRINT("send request authentication_data {ueId} PATCH eps", tab=2)
        HELP_PRINT("send request authentication_data {ueId} PATCH ims", tab=2)
        HELP_PRINT("send request authentication_data {ueId} PATCH wifi", tab=2)
        ...
        HELP_PRINT("send request location_data {ueId} PATCH BITMASK 123456", tab=2)

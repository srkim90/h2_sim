...
def send_request(command, path, method, data):
    #PRINT("Enter MMC in '%s'" % command)

    iwk = h2_interwork.getinstance()
    nErr = iwk.h2_send_request(method, path, data)   
...
class __mmc_api_GET_subscriber_id_data(mmc):
    ...
    def run(command):
        ...
        return
mmc_append(["subscriber_id_data"      ,  2, "send-request-subscriber_id_data"                                   , None                                      ])
mmc_append(["UeId"                    ,  3, "send-request-subscriber_id_data-S"                                 , None                                      ])
mmc_append(["GET"                     ,  4, "send-request-subscriber_id_data-S-GET"                             , __mmc_api_GET_subscriber_id_data          ])
''' end of API '''
...
class __mmc_api_GET_authentication_data(mmc):
    ...
    def run(command):
        ...
        send_request(command, __path, "GET", None)
        return
mmc_append(["authentication_data"     ,  2, "send-request-authentication_data"                                  , None                                      ])
mmc_append(["UeId"                    ,  3, "send-request-authentication_data-S"                                , None                                      ])
mmc_append(["GET"                     ,  4, "send-request-authentication_data-S-GET"                            , None                                      ])
mmc_append(["ALL"                     ,  5, "send-request-authentication_data-S-GET-ALL"                        , __mmc_api_GET_authentication_data         ])
mmc_append(["eps"                     ,  5, "send-request-authentication_data-S-GET-eps"                        , __mmc_api_GET_authentication_data         ])
mmc_append(["ims"                     ,  5, "send-request-authentication_data-S-GET-ims"                        , __mmc_api_GET_authentication_data         ])
mmc_append(["wifi"                    ,  5, "send-request-authentication_data-S-GET-wifi"                       , __mmc_api_GET_authentication_data         ])
...
class __mmc_api_GET_eps_am_data(mmc):
    ...
    def run(command):
        ...
        send_request(command, __path, "GET", None)
        return
mmc_append(["eps_am_data"             ,  2, "send-request-eps_am_data"                                          , None                                      ])
mmc_append(["ueId"                    ,  3, "send-request-eps_am_data-S"                                        , None                                      ])
mmc_append(["GET"                     ,  4, "send-request-eps_am_data-S-GET"                                    , None                                      ])
mmc_append(["ALL"                     ,  5, "send-request-eps_am_data-S-GET-ALL"                                , __mmc_api_GET_eps_am_data                 ])
mmc_append(["active_apn_data"         ,  5, "send-request-eps_am_data-S-GET-active_apn_data"                    , __mmc_api_GET_eps_am_data                 ])
...
class __mmc_api_POST_eps_am_data(mmc):
    ...
    def run(command):
        ...
        return
mmc_append(["POST"                    ,  4, "send-request-eps_am_data-S-POST"                                   , None                                      ])
mmc_append(["active_apn_data"         ,  5, "send-request-eps_am_data-S-POST-active_apn_data"                   , None                                      ])
mmc_append(["apnContextId"            ,  6, "send-request-eps_am_data-S-POST-active_apn_data-S"                 , __mmc_api_POST_eps_am_data                ])
...
class __mmc_api_PUT_eps_am_data(mmc):
    ...
    def run(command):
        ...
        __path    = "%s/%s/eps-am-data/active-apn-data/%s" % (ROOT_API, __ueId, __apn_cid)
        __data, name   = builder().build_ActiveApnData(__ueId)
        send_request(command, __path, "PUT", __data)
        return
mmc_append(["PUT"                     ,  4, "send-request-eps_am_data-S-PUT"                                    , None                                      ])
mmc_append(["active_apn_data"         ,  5, "send-request-eps_am_data-S-PUT-active_apn_data"                    , None                                      ])
mmc_append(["apnContextId"            ,  6, "send-request-eps_am_data-S-PUT-active_apn_data-S"                  , __mmc_api_PUT_eps_am_data                 ])
...
class __mmc_api_DELETE_eps_am_data(mmc):
    ...
    def run(command):
        ...
        return
mmc_append(["DELETE"                  ,  4, "send-request-eps_am_data-S-DELETE"                                 , None                                      ])
mmc_append(["active_apn_data"         ,  5, "send-request-eps_am_data-S-DELETE-active_apn_data"                 , None                                      ])
mmc_append(["ALL"                     ,  5, "send-request-eps_am_data-S-DELETE-ALL"                             , __mmc_api_DELETE_eps_am_data              ])
mmc_append(["apnContextId"            ,  6, "send-request-eps_am_data-S-DELETE-active_apn_data-S"               , __mmc_api_DELETE_eps_am_data              ])
''' end of API '''
...
class __mmc_api_GET_ims_am_data(mmc):
    ...
    def run(command):
        ...
        send_request(command, __path, "GET", None)
        return
mmc_append(["ims_am_data"             ,  2, "send-request-ims_am_data"                                          , None                                      ])
mmc_append(["ueId"                    ,  3, "send-request-ims_am_data-S"                                        , None                                      ])
mmc_append(["GET"                     ,  4, "send-request-ims_am_data-S-GET"                                    , None                                      ])
mmc_append(["ALL"                     ,  5, "send-request-ims_am_data-S-GET-ALL"                                , __mmc_api_GET_ims_am_data                 ])
mmc_append(["cscf_restore_data"       ,  5, "send-request-ims_am_data-S-GET-cscf_restore_data"                  , __mmc_api_GET_ims_am_data                 ])
mmc_append(["as_notify_data"          ,  5, "send-request-ims_am_data-S-GET-as_notify_data"                     , __mmc_api_GET_ims_am_data                 ])
...
class __mmc_api_POST_ims_am_data(mmc):
    ...
    def run(command):
        ...
        send_request(command, __path, "POST", __data)
        return
mmc_append(["POST"                    ,  4, "send-request-ims_am_data-S-POST"                                   , None                                      ])
mmc_append(["cscf_restore_data"       ,  5, "send-request-ims_am_data-S-POST-cscf_restore_data"                 , None                                      ])
mmc_append(["imsPrivateUserId"        ,  6, "send-request-ims_am_data-S-POST-cscf_restore_data-S"               , __mmc_api_POST_ims_am_data                ])
mmc_append(["as_notify_data"          ,  5, "send-request-ims_am_data-S-POST-as_notify_data"                    , None                                      ])
mmc_append(["asGroupId"               ,  6, "send-request-ims_am_data-S-POST-as_notify_data-S"                  , None                                      ])
mmc_append(["dataReferenceId"         ,  7, "send-request-ims_am_data-S-POST-as_notify_data-S-S"                , __mmc_api_POST_ims_am_data                ])
...
class __mmc_api_PUT_ims_am_data(mmc):
    ...
    def run(command):
        ...
        send_request(command, __path, "PUT", __data)
        return
mmc_append(["PUT"                     ,  4, "send-request-ims_am_data-S-PUT"                                    , None                                      ])
mmc_append(["cscf_restore_data"       ,  5, "send-request-ims_am_data-S-PUT-cscf_restore_data"                  , None                                      ])
mmc_append(["imsPrivateUserId"        ,  6, "send-request-ims_am_data-S-PUT-cscf_restore_data-S"                , __mmc_api_PUT_ims_am_data                 ])
mmc_append(["as_notify_data"          ,  5, "send-request-ims_am_data-S-PUT-as_notify_data"                     , None                                      ])
mmc_append(["asGroupId"               ,  6, "send-request-ims_am_data-S-PUT-as_notify_data-S"                   , None                                      ])
mmc_append(["dataReferenceId"         ,  7, "send-request-ims_am_data-S-PUT-as_notify_data-S-S"                 , __mmc_api_PUT_ims_am_data                 ])
...
class __mmc_api_DELETE_ims_am_data(mmc):
    ...
    def run(command):
        ...
        send_request(command, __path, "DELETE", __data)
        return
mmc_append(["DELETE"                  ,  4, "send-request-ims_am_data-S-DELETE"                                 , None                                      ])
#mmc_append(["cscf_restore_data"       ,  5, "send-request-ims_am_data-S-DELETE-cscf_restore_data"               , None                                      ])
#mmc_append(["imsPrivateUserId"        ,  6, "send-request-ims_am_data-S-DELETE-cscf_restore_data-S"             , __mmc_api_DELETE_ims_am_data              ])
mmc_append(["as_notify_data"          ,  5, "send-request-ims_am_data-S-DELETE-as_notify_data"                  , None                                      ])
mmc_append(["ALL"                     ,  6, "send-request-ims_am_data-S-DELETE-as_notify_data-ALL"              , __mmc_api_DELETE_ims_am_data              ])
mmc_append(["SELECT"                  ,  6, "send-request-ims_am_data-S-DELETE-as_notify_data-SELECT"           , None                                      ])
mmc_append(["asGroupId"               ,  7, "send-request-ims_am_data-S-DELETE-as_notify_data-SELECT-S"         , None                                      ])
mmc_append(["dataReferenceId"         ,  8, "send-request-ims_am_data-S-DELETE-as_notify_data-SELECT-S-S"       , __mmc_api_DELETE_ims_am_data              ])
mmc_append(["cscf_restore_data"       ,  5, "send-request-ims_am_data-S-DELETE-cscf_restore_data"               , __mmc_api_DELETE_ims_am_data              ])
''' end of API '''
...
class __mmc_api_GET_location_data(mmc):
    ...
    def run(command):
        ...
        send_request(command, __path, "GET", None)
        return
mmc_append(["location_data"   ,  2, "send-request-location_data"                                 , None                         ])
mmc_append(["ueId"            ,  3, "send-request-location_data-S"                               , None                         ])
mmc_append(["GET"             ,  4, "send-request-location_data-S-GET"                           , None                         ])
mmc_append(["ALL"             ,  5, "send-request-location_data-S-GET-ALL"                       , __mmc_api_GET_location_data  ])
mmc_append(["SELECT"          ,  5, "send-request-location_data-S-GET-SELECT"                    , None                         ])
mmc_append(["BITMASK"         ,  5, "send-request-location_data-S-GET-BITMASK"                   , None                         ])
mmc_append(["CsLocationData"  ,  6, "send-request-location_data-S-GET-SELECT-CsLocationData"     , __mmc_api_GET_location_data  ])
mmc_append(["PsLocationData"  ,  6, "send-request-location_data-S-GET-SELECT-PsLocationData"     , __mmc_api_GET_location_data  ])
mmc_append(["EpsLocationData" ,  6, "send-request-location_data-S-GET-SELECT-EpsLocationData"    , __mmc_api_GET_location_data  ])
mmc_append(["ImsLocationData" ,  6, "send-request-location_data-S-GET-SELECT-ImsLocationData"    , __mmc_api_GET_location_data  ])
mmc_append(["AsLocationData"  ,  6, "send-request-location_data-S-GET-SELECT-AsLocationData"     , __mmc_api_GET_location_data  ])
mmc_append(["__bit_flags"     ,  6, "send-request-location_data-S-GET-BITMASK-S"                 , __mmc_api_GET_location_data  ])
...
class __mmc_api_PATCH_location_data(mmc):
    ...
    def run(command):
        ...
        send_request(command, __path, "PATCH", __json)
        return
mmc_append(["PATCH"            ,  4, "send-request-location_data-S-PATCH"                         , None                          ])
mmc_append(["ALL"              ,  5, "send-request-location_data-S-PATCH-ALL"                     , __mmc_api_PATCH_location_data ])
mmc_append(["SELECT"           ,  5, "send-request-location_data-S-PATCH-SELECT"                  , None                          ])
mmc_append(["BITMASK"          ,  5, "send-request-location_data-S-PATCH-BITMASK"                 , None                          ])
mmc_append(["CommLocationData" ,  6, "send-request-location_data-S-PATCH-SELECT-CommLocationData" , __mmc_api_PATCH_location_data ])
mmc_append(["CsLocationData"   ,  6, "send-request-location_data-S-PATCH-SELECT-CsLocationData"   , __mmc_api_PATCH_location_data ])
mmc_append(["PsLocationData"   ,  6, "send-request-location_data-S-PATCH-SELECT-PsLocationData"   , __mmc_api_PATCH_location_data ])
mmc_append(["EpsLocationData"  ,  6, "send-request-location_data-S-PATCH-SELECT-EpsLocationData"  , __mmc_api_PATCH_location_data ])
mmc_append(["ImsLocationData"  ,  6, "send-request-location_data-S-PATCH-SELECT-ImsLocationData"  , __mmc_api_PATCH_location_data ])
mmc_append(["AsLocationData"   ,  6, "send-request-location_data-S-PATCH-SELECT-AsLocationData"   , __mmc_api_PATCH_location_data ])
mmc_append(["__bit_flags"      ,  6, "send-request-location_data-S-PATCH-BITMASK-S"               , __mmc_api_PATCH_location_data ])
''' end of API '''
...
class __mmc_api_GET_supplement_service_data(mmc):
    ...
    def run(command):
        ...
        return
mmc_append(["supplement_service_data" ,  2, "send-request-supplement_service_data"                                  , None                                       ])
mmc_append(["ueId"                    ,  3, "send-request-supplement_service_data-S"                                , None                                       ])
mmc_append(["GET"                     ,  4, "send-request-supplement_service_data-S-GET"                            , None                                       ])
mmc_append(["ALL"                     ,  5, "send-request-supplement_service_data-S-GET-ALL"                        , __mmc_api_GET_supplement_service_data      ])
mmc_append(["SELECT"                  ,  5, "send-request-supplement_service_data-S-GET-SELECT"                     , None                                       ])
mmc_append(["BITMASK"                 ,  5, "send-request-supplement_service_data-S-GET-BITMASK"                    , None                                       ])
mmc_append(["BasicServiceData"        ,  6, "send-request-supplement_service_data-S-GET-SELECT-BasicServiceData"    , __mmc_api_GET_supplement_service_data      ])
mmc_append(["CFServiceData"           ,  6, "send-request-supplement_service_data-S-GET-SELECT-CFServiceData"       , __mmc_api_GET_supplement_service_data      ])
mmc_append(["SNDServiceData"          ,  6, "send-request-supplement_service_data-S-GET-SELECT-SNDServiceData"      , __mmc_api_GET_supplement_service_data      ])
...
class __mmc_api_PATCH_supplement_service_data(mmc):
    ...
    def run(command):
        ...
        send_request(command, __path, "PATCH", {name : __data})
        return
mmc_append(["PATCH"                 ,  4, "send-request-supplement_service_data-S-PATCH"                          , None                                       ])
mmc_append(["BasicServiceData"      ,  5, "send-request-supplement_service_data-S-PATCH-BasicServiceData"       , __mmc_api_PATCH_supplement_service_data    ])
mmc_append(["CFServiceData"         ,  5, "send-request-supplement_service_data-S-PATCH-CFServiceData"          , __mmc_api_PATCH_supplement_service_data    ])
mmc_append(["SNDServiceData"        ,  5, "send-request-supplement_service_data-S-PATCH-SNDServiceData"         , __mmc_api_PATCH_supplement_service_data    ])
